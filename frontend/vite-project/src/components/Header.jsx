...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      {/* w-8	Width = 2rem (Tailwind spacing 8 → 8 * 0.25rem = 2rem) aspect-square	Aspect ratio = 1 / 1 (height equals width → perfect square shape) The element will be a square of 2rem x 2rem. */}
